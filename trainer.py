...
def Trainer(model, model_optimizer, classifier, classifier_optimizer, sourcedata_path, device,
    ...
    if training_mode == 'pre_train':
        ...
        torch.save({'model_state_dict': model.state_dict()}, os.path.join(experiment_log_dir, "saved_models", 'model_pretraine.pt'))
        ...
        pretrained_model_path = os.path.join(experiment_log_dir, "saved_models", 'model_pretraine.pt')
